...
console.log(colors.cyan('📚 Swagger documentation available at http://localhost:3000/api-docs'));

app.listen(PORT, () => {
    console.log(colors.green(`✔ Server is running on port ${PORT}`));
    console.log(colors.yellow(`🌐 Frontend CORS allowed for: http://localhost:5173`));
});